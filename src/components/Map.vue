<template>
    <div class="reb-Map">
        ...
        <canvas ref="heatCanvas" id="heatCanvasElement" class="reb-Map__canvas"></canvas>
        <canvas ref="hexagonCanvas" class="reb-Map__canvas" style="opacity: .3;"></canvas>
        <span style="position: fixed; top: 0; left: 0; font-weight: bold;">{{ hexagonCount }}</span>
    </div>
